...
export const OPT_IN_CONTENT = {
  ...
  'carb-quiz': {
    headline: 'The Carb Counting Masterclass — In Quiz Form',
    subhead: "Fourteen questions across the four skills every T1D needs to dose accurately: spotting carbs, predicting their speed, reading the labels, and reading the plate. About 5 minutes — the foundation of every insulin decision you'll ever make.",
    bullets: [
      'Section 1 — Where carbs actually live (and the foods that trip everyone up)',
      'Section 2 — High vs Low GI: which carbs spike, which carbs simmer',
      'Section 3 — Pulling carb counts off real nutrition labels',
      'Section 4 — Scanning a full plate, not just the centrepiece',
    ],
    ctaText: 'Start The Quiz',
    placeholderIcon: '❓',
    placeholderTagline: 'The foundational reps every accurate dosing decision rests on',
  },
}
