export default function Footer() {
  return (
    <footer className="bg-da-darker border-t border-white/10 py-16 md:py-20">
      <div className="da-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-12">
          <div>
            <h3 className="font-black uppercase tracking-wider text-white mb-4 text-lg">
              <span className="text-da-cyan">DIABETIC</span> ATHLETIC
            </h3>
            <p className="text-white/60 text-sm leading-relaxed">Turning diabetic struggles into fitness successes.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed">Follow us on social media</p>
          </div>
        </div>
